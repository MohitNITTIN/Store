...
const Register = () => {
    const loginWithGoogle = () => {
        ...
        window.open(
            `${MODE === "dev" ? SERVER_DEV_API : SERVER_PROD_API}/api/v1/google`,
            "_self"
        );
    ...
    return (
        <>
            ...
            <button onClick={loginWithGoogle} className="text-white py-3 w-full bg-primary-orange shadow hover:shadow-lg rounded-sm font-medium">Google Login</button>
